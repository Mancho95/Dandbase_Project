<?php /* Smarty version 2.6.26, created on 2018-05-11 14:53:07
         compiled from registrazione_conferma.tpl */ ?>
<form method="post" action="index.php">
    <div id="staff" class="container">
        <div class="title">
            <p><input type="hidden" name="controller" value="registrazione" /></p>
            <p><input type="hidden" name="task" value="autentica" /></p>
            <b><h2>Registration complete! Welcome to DnBase!</h2>
                <span><font color="#690813" size="4.5"><b>Enter your infos to log in.</b></font></span>
